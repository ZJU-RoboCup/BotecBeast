 ...
 * @return ZMP
 */
Eigen::Vector3d computeCentroidalZMPComplete(
    MultiBodyConfig& mbc, Eigen::Vector3d& com, Eigen::Vector3d& comA,
    double altitude, sva::ForceVecd wr_external, double mass);
