 ...
 */
void imagePointJacobian(const Eigen::Vector2d& point2d,
 ...
 * @param jac is the output Jacobian
 */
void imagePointJacobian(const Eigen::Vector3d& point3d,
                        Eigen::Matrix<double, 2, 6>& jac);
...
void imagePointJacobianDot(const Eigen::Vector2d imagePoint,
                           ...
                           const double depth, const double depthDot,
                           Eigen::Matrix<double, 2, 6>& jac);
 ...
 *representation where the angle is considered as zero
 */
void poseJacobian(const Eigen::Matrix3d& rotation,
 ...
 */
void getAngleAxis(const Eigen::Matrix3d& rotation, double& rot_angle,
