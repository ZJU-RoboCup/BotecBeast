...
class ParameterOfPosture(object):
    ...
    def getleftlegpos(self):
        left_eulor = np.array([-self.Torso_P,-self.Torso_Y,-self.Torso_R])
        ...
        left_vector_wf = np.matmul(left_rotation, left_vector_wf)
        #######################################################
    ...
    def getrightlegpos(self):
        right_eulor = np.array([-self.Torso_P,-self.Torso_Y,-self.Torso_R])
        ...
        right_vector_wf = np.matmul(right_rotation, right_vector_wf)
        #######################################################
